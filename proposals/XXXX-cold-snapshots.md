...
struct AddAccountData {
    ...
    payload_sz: u64,            // Size of compressed data in this object
    accounts_cnt: u32,
...
**Multi-Object Support**: Multiple `AddAccountData` objects may exist in a single chunk file to enable parallel decompression and account insertion. Each object MUST NOT exceed 4GB of uncompressed account data (the decompressed size MUST be ≤ 4,294,967,296 bytes).
